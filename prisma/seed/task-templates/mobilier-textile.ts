...
export const mobilierTextileTemplates: Template[] = [
  {
    ...
    items: {
      create: [
        { category: 'LIVING_SPACES', title: 'Identifier le type de tissu (coton, lin, microfibre, etc.)' },
        { category: 'LIVING_SPACES', title: 'Vérifier l\'étiquette d\'entretien du fabricant' },
        { category: 'LIVING_SPACES', title: 'Tester la solidité des couleurs sur une zone cachée' },
