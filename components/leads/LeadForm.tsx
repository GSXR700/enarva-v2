        ...
        <TabsContent value="general">
          <Card>
            ...
            <CardContent className="grid grid-cols-2 gap-4">
              ...
              <div>
                <Label htmlFor="score">Score Lead (0-100)</Label>
                <Input
                  id="score"
                  type="number"
                  min="0"
        ...
        <TabsContent value="request">
          <Card>
            ...
            <CardContent className="space-y-4">
              ...
              <div>
                <Label>Matériaux Présents</Label>
                <div className="grid grid-cols-3 gap-3 mt-2">
                  <div className="flex items-center space-x-2">
                    <Checkbox
                      id="marble"
                      checked={form.watch('materials.marble') || false}
                      onCheckedChange={(checked) => 
                        form.setValue('materials.marble', checked as boolean)
                      }
                    />
                  ...
                  <div className="flex items-center space-x-2">
                    <Checkbox
                      id="parquet"
                      checked={form.watch('materials.parquet') || false}
                      onCheckedChange={(checked) => 
                        form.setValue('materials.parquet', checked as boolean)
                      }
                    />
                  ...
                  <div className="flex items-center space-x-2">
                    <Checkbox
                      id="tiles"
                      checked={form.watch('materials.tiles') || false}
                      onCheckedChange={(checked) => 
                        form.setValue('materials.tiles', checked as boolean)
                      }
                    />
                  ...
                  <div className="flex items-center space-x-2">
                    <Checkbox
                      id="carpet"
                      checked={form.watch('materials.carpet') || false}
                      onCheckedChange={(checked) => 
                        form.setValue('materials.carpet', checked as boolean)
                      }
                    />
                  ...
                  <div className="flex items-center space-x-2">
                    <Checkbox
                      id="concrete"
                      checked={form.watch('materials.concrete') || false}
                      onCheckedChange={(checked) => 
                        form.setValue('materials.concrete', checked as boolean)
                      }
                    />
