          ...
          if (response.ok) {
            ...
            if (leadData.materials && typeof leadData.materials === 'object') {
              setSelectedMaterials({
                ...
                parquet: leadData.materials.parquet || false,
                tiles: leadData.materials.tiles || false,
                carpet: leadData.materials.carpet || false,
                concrete: leadData.materials.concrete || false,
                porcelain: leadData.materials.porcelain || false,
                cladding: leadData.materials.cladding || false,
                composite_wood: leadData.materials.composite_wood || false,
                pvc: leadData.materials.pvc || false,
                other: leadData.materials.other || ''
              });
              console.log('✅ Materials loaded from lead:', leadData.materials)
            }
