//app/(administration)/teams/[id]/edit/page.tsx
'use client'
...
export default function EditTeamMemberPage() {
  ...
  if (isLoading) {
    return <TableSkeleton title="Modification d'un membre..." />;
  }
    ...
    <div className="main-content space-y-6">
      <div className="flex items-center gap-4">
        ...
        <div>
          ...
          <p className="text-muted-foreground mt-1">Mise à jour du profil de {formData.firstName} {formData.lastName}.</p>
        </div>
      </div>
          ...
          <CardContent className="space-y-6">
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              ...
              <div>
                ...
                <Select value={formData.user?.role} onValueChange={(v) => handleSelectChange('role', v)}>
